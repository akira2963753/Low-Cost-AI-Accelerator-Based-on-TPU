...
舉例來說，以0.10534來說，我們將其轉換成定點數格式，可以得到0.10534x128=13.48(round)=13=00001101，因此我們可以將前面的四位元0縮減成一位元的0，也不會損失精準度。   
如果以-0.0784來說，我們可以得到-0.0784x128=-10.0352(round)=-10=11110110，一樣可以將前面四位元的1縮減成一位元的1。  
