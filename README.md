...
We build upon the MSR-4 data characteristic proposed in our senior’s thesis [0]  , which helps reduce weight bit-length, and further design a compensation architecture to offset the loss caused by Non-MSR-4 data.   
